 ...
 * appearance
 *
 * font: see h//freedesktop.org/software/fontconfig/fontconfig-user.html
 */
static char *font = "monofur for Powerline:pixelsize=13:antialias=true:autohint=true";
...
/* bg opacity */
float alpha = 0.88888888444; // change to change alpha
